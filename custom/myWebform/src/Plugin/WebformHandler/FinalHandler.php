...
namespace Drupal\myWebform\Plugin\WebformHandler;
...
class FinalHandler extends WebformHandlerBase {
  ...
  public function postSave(WebformSubmissionInterface $webform_submission, $update = TRUE) {
    ...
    //   $file = File::load($webform_submission->getData($file_field_name)['file']);
